...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([["Bairros.JSON",new URL("./files/2ac0771249463a67fa130373fe3e3b63a2f48f6a2a0ea7b1de1ff7e89bc66db698b3d9872c12aace3b2b7deac1596e28c893ad049025d3f1aa94903a123bf7a1",import.meta.url)]]);
  main.builtin("FileAttachment", runtime.fileAttachments(name => fileAttachments.get(name)));
  main.variable(observer()).define(["md"], function(md){return(
md`# Hierarchical Bar Chart - RECIFE BAIRROS
...
FileAttachment("Bairros.JSON").json()
)});
